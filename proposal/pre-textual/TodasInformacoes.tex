...
\newcommand{\TítuloObtido}{%
  Tese apresentada para obtenção do título de Bacharel em Ciências da Computação
}
...
\newcommand{\PalavrasChave}{%
  Hidden Markov Chains, Limit Order Book Modelling, High-Frequency Data, Neural Networks, Hawkes Processes\\
}
\newcommand{\JELCodes}{%
C45; C15; G17
}
