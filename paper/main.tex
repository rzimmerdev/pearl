...
%]{USPSC-classe/USPSC1} %- páginas ímpares: com seções ou subseções e o número da página e páginas pares: com o número da página e o título do capítulo
...
\bibliography{USPSC-bib/bibliograpy}
