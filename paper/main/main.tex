...
\newcommand{\Fullimg}[1]{\hyperref[#1]{Figure~\ref*{#1}}}
\newcommand{\fullimg}[1]{\hyperref[#1]{figure~\ref*{#1}}}
...
%Capa do ICMC
    \include{pretextual/USPSC-CapaICMC}
...
% \includepdf{pretextual/USPSC-fichacatalografica.pdf}
    \include{pretextual/USPSC-fichacatalografica}

% Folha de rosto adicional
    \imprimirfolhaderostoadic*

% Inserir errata
%\include{pretextual/USPSC-Errata}
...
% \includepdf{pretextual/USPSC-PaginaEmBranco.pdf}
% Dedicatória
%\include{pretextual/USPSC-Dedicatoria}

% Agradecimentos
%\include{pretextual/USPSC-Agradecimentos}

% Epígrafe
%\include{pretextual/USPSC-Epigrafe}
...
%\input{pretextual/USPSC-AbreviaturasSiglas}

% inserir lista de símbolos
%\input{pretextual/USPSC-Simbolos}
...
% Capítulo 1 - Introdução
    ...
    \include{textual/literature}

% Capítulo 2
    \include{textual/development}
