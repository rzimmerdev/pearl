...
\instituicao{Institute of Mathematics and Computer Sciences, University of São Paulo}
...
\tituloadic{Uma Abordagem Distribuída para Aprendizado por Reforço Multiagente voltada à Trading de Alta Frequência}
\tituloresumo{Uma Abordagem Distribuída para Aprendizado por Reforço Multiagente voltada à Trading de Alta Frequência}
...
\notaautorizacao{
    I AUTORIZE THE REPRODUCTION AND DISSEMINATION OF TOTAL OR PARTIAL COPIES OF THIS DOCUMENT, 
    BY CONVENTIONAL OR ELECTRONIC MEDIA, FOR STUDY OR RESEARCH PURPOSES, PROVIDED IT IS PROPERLY REFERENCED.
}
...
%	\preambulo{Course Conclusion thesis submitted to the Undergraduate Program of the Institute of Mathematics and Computer Sciences, University of S\~ao Paulo - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Computer Science.}
    \preambulo{Course Conclusion Thesis submitted in partial fulfillment of the requirements for the Undergraduate Degree Program of Bachelor in Computer Science, at the Institute of Mathematics and Computer Sciences, University of S\~ao Paulo - ICMC/USP.}
...
%	\notacapaicmc{Course Conclusion Thesis to the Undergraduate Program Bachelor's in\\ Computer Sciences}
    \notacapaicmc{Course Conclusion Thesis for the Bachelor's Degree in Computer Science}
    }{
 % BCCp ==========================================================================
