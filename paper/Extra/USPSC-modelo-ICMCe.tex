...
]{USPSC-classe/USPSC} %- páginas ímpares: com seções ou subseções e o número da página
%]{USPSC-classe/USPSC1} %- páginas pares: com o número da página e o título do capítulo
% ---
...
% Para utilizar o sistema de chamada numérico para citações e referências, habilitar um dos comandos abaixo.
...
% As informações que compõem a ficha catalográfica estão definidas no arquivo USPSC-TCC-pre-textual-ICMC.tex
...
% A T E N Ç Ã O
% Se o idioma do texto for em inglês, o abstract deve preceder o resumo resumo em português
